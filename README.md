...
Esta es una prueba técnica para evaluar tus habilidades en el desarrollo de aplicaciones web. El objetivo es crear una aplicación web que permita a los usuarios ver una lista de libros y crear una lista de lectura.

Esta prueba técnica se basa en el repositorio [reading-list](https://github.com/midudev/pruebas-tecnicas/tree/main/pruebas/01-reading-list) de [midudev](https://github.com/midudev). He tomado la prueba como referencia para practicar mis habilidades en React y TypeScript, y he subido mi versión a este repositorio con el objetivo de poner a prueba mis conocimientos y ofrecer una base para futuras mejoras.
